...
def sword1():
    if drawncard1 == '!!HISSING CREEPER!!' or '!!!!CHARGED HISSING CREEPER':
        print('Type the exact name of the sword, without the exclamation marks')
        print('Details of the swords(must read): https://github.com/victorcai2020/Hissing_Creepers/wiki/Swords')
        swduse1 = input('What type of sword do you want to play(type gibberish to not play a sword)? ')
        if swduse1 == 'Wood sword':
            for x in range(4):
                h1.remove('Wood sword')
            h1.remove('!!HISSING CREEPER!!' or '!!!!CHARGED HISSING CREEPER!!!!')
            print(h1)
        if swduse1 == 'Stone sword':
            for x in range(3):
                h1.remove('Stone sword')
            h1.remove('!!HISSING CREEPER!!' or '!!!!CHARGED HISSING CREEPER!!!!')
            print(h1)
        if swduse1 == 'Iron sword':
            for x in range(2):
                h1.remove('Iron sword')
            h1.remove('!!HISSING CREEPER!!' or '!!!!CHARGED HISSING CREEPER!!!!')
            print(h1)
        if swduse1 == 'DIAMOND SWORD':
            h1.remove('DIAMOND SWORD!!')
            h1.remove('!!HISSING CREEPER!!' or '!!!!CHARGED HISSING CREEPER!!!!')
            print(h1)

def sword2():
    if drawncard2 == '!!HISSING CREEPER!!' or '!!!!CHARGED HISSING CREEPER!!!!':
        print('Type the exact name of the sword, without the exclamation marks')
        print('Details of the swords(must read): https://github.com/victorcai2020/Hissing_Creepers/wiki/Swords')
        swduse2 = input('What sword do you want to play(type gibberish to not play a sword)? ')
        if swduse2 == 'Wood sword':
            for x in range(4):
                h2.remove('Wood sword')
            h2.remove('!!HISSING CREEPER!!' or '!!!!CHARGED HISSING CREEPER!!!!')
            print(h2)
        if swduse2 == 'Stone sword':
            for x in range(3):
                h2.remove('Stone sword')
            h2.remove('!!HISSING CREEPER!!' or '!!!!CHARGED HISSING CREEPER!!!!')
            print(h2)
        if swduse2 == 'Iron sword':
            for x in range(2):
                h2.remove('Iron sword')
            h2.remove('!!HISSING CREEPER!!' or '!!!!CHARGED HISSING CREEPER!!!!')
            print(h2)
        if swduse2 == 'DIAMOND SWORD':
            h2.remove('DIAMOND SWORD!!')
            h2.remove('!!HISSING CREEPER!!' or '!!!!CHARGED HISSING CREEPER!!!!')
            print(h2)
    ...
    if p1i == "play":
        ...
        if p1p == 'Bad Omen':
            if 'Villager'in h1:
                ...
                print('There is no village to raid.')
