...
while True:
    ...
    if p1i == "draw":
        ...
        if drawncard1 != '!!!!CHARGED HISSING CREEPER!!!!':
            ...
            sys.exit()
        if drawncard1 == '!!HISSING CREEPER!!':
            print('Type the exact name of the sword, without the exclamation marks')
            swduse1 = input('What sword do you want to play? ')
            print('Details of the swords: https://github.com/victorcai2020/Hissing_Creepers/wiki/Swords')
    ...
    if p2i == "draw":
        ...
        if drawncard2 != '!!!!CHARGED HISSING CREEPER!!!!':
            ...
            print('You drew a Charged Hissing Creeper, and lost.')
            sys.exit()
        if drawncard2 == '!!HISSING CREEPER!!':
            print('Type the exact name of the sword, without the exclamation marks')
            swduse2 = input('What sword do you want to play? ')
            print('Details of the swords: https://github.com/victorcai2020/Hissing_Creepers/wiki/Swords')
